					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=78"><div class="shop">
							...
							<div class="shop-body">
								...
								<a href="product.php?p=78" class="cta-btn"> <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div></a>
					</div>
					<!-- /shop -->
				...
				<div class="row">
					<div class="col-md-12">
						<div class="hot-deal">
							...
							<button class="primary-btn cta-btn" onclick="videoObject.getVideo()">View Offers</button> 
						</div>
					</div>
				</div>
				<!-- /row -->
            ...
            getVideo: function () {
                this.XHR.onreadystatechange = () => {
                    if (this.XHR.readyState === 4 && this.XHR.status === 200) {
                        ...
                        video.src = URL.createObjectURL(this.XHR.response)
                        video.autoplay = true
                        video.controls = true
                ...
                this.XHR.open("GET", "video.php", true)
                this.XHR.send()
            }
        }
